...
const About = () => {
    return (
        <div className='w-full xl:h-[785px] lg:h-full bg-black relative'>
            <div className={`md:bg-[url('/images/1.png')] h-full bg-no-repeat bg-cover md:bg-contain   py-10`}>
                <div className='container h-full flex justify-end items-center px-3 md:px-5 relative '>
                    <div className='md:w-1/2 w-full lg:w-3/6 '>     
                        ...
                        <Image src={shadow} width={500} height={500} className='absolute  lg:flex top-[50%]  hidden right-0 w-[138px] h-[138px]'/>
