        ...
        <div className='relative'>
            <div className='w-full pt-24  bg-[#01060f] mt-28 z-10'>
                <div className='container px-3 md:px-5 2xl:px-0 relative'>
                    ...
                    <Image src={ellipse} width={500} height={500} className='absolute top-[10%] md:flex hidden left-[25%]' />
            ...
            <Image src={ellipse1} width={500} height={500} className='absolute -top-60 left-60 md:flex hidden  opacity-70 z-0 ' />
        </div>
    );
};
